                ...
                <div class="active tab-pane" id="gashapon">
                    <form method='post' action='<?php echo base_url() . 'index.php/GashaController/actionEditGashapon'; ?>'>
                        <div class="modal-body">
                            ...
                            <input type='hidden' name='gashaNo' id='gashaNo'/>
...
<script>
    $('#gashaNo').val('<?php echo $itemInfo->no;?>');
    $('#gashaItemID').val('<?php echo $itemInfo->ItemID;?>');
    $('#gashaIDType').val('<?php echo $type?>');
    $('#gashaType').val('<?php echo $itemInfo->Type;?>');
    $('#gashaQuantity').val("<?php echo $itemInfo->Quantity;?>");
    $('#gashaTier').val('<?php echo $itemInfo->Tier;?>');
    $('#gashaWeight').val('<?php echo $itemInfo->Weight;?>');
</script>
